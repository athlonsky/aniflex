        ...
        <div className="flex flex-col md:flex-row items-center w-11/12 mx-auto gap-4">
          ...
          <div className="flex flex-col p-2 flex-0">
            <div className="flex flex-row sm:mt-10 flex-wrap gap-4 w-full">
              ...
              <div className='flex my-auto mx-auto w-fit flex-auto'>
                {user &&
            ...
            <div className={`px-4 bg- rounded-2xl py-2 flex lg:max-h-[10rem] max-h-[5rem] overflow-y-scroll scrollbar-hide flex-row m-1 mt-3 text-xs lg:text-lg text-slate-50 text-shadow-xl border-secondary/30 w-11/12`}>
              <div>
                <div>
                  {parse(`Synopsis : ${deets.description}`)}
                </div>
              </div>
            </div>
            <div className="flex gap-2 flex-wrap my-2">
              <div className="px-5 py-1 flex text-sm lg:text-lg text-slate-100 border-secondary/30 text-shadow-xl w-fit">
                Rating: {deets.score.decimalScore}
              </div>
              <div className="px-1 py-1 flex text-sm lg:text-lg text-slate-100 border-secondary/30 text-shadow-xl w-fit">
                Type: {deets.format}
              </div>
              <div className="px-1 py-1 capitalize flex text-sm lg:text-lg text-slate-100 border-secondary/30 text-shadow-xl w-fit">
