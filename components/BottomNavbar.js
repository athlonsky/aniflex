  ...
  return(
    <div className="btm-nav border-2 border-secondary bg-base-100/40 backdrop-blur-md btm-nav-sm text-sm mb-[2rem] mx-auto rounded-full w-6/12 align-self-center font-bold fixed z-30 lg:hidden">
      ...
      <Link href='/searchpage'>
        <button className={router.pathname == "/searchpage" ? "active: text-secondary bg-base-100/40 rounded-r-full border-0":"text-primary"}> 
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-6 h-6 scale-[125%]">
